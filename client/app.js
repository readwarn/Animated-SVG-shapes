app = new Vue({
  ...
  methods: {
    ...
    resizeL(event, key) {
      this.shapes[key].points = this.getPoints(
        this.shapes[key].sides,
        parseInt(event.target.value)
      );
      this.shapes[key].dash = {
        strokeDasharray: this.polygonPerimeter(
          this.shapes[key].sides,
          parseInt(event.target.value)
        ),
        strokeDashoffset: this.polygonPerimeter(
          this.shapes[key].sides,
          parseInt(event.target.value)
        ),
      };
    ...
    resizeRx(event, key) {
      ...
      this.shapes[key].dash = {
        strokeDasharray: this.ellipsePermiter(
          parseInt(event.target.value),
          this.ry
        ),
        strokeDashoffset: this.ellipsePermiter(
          parseInt(event.target.value),
          this.ry
        ),
      };
